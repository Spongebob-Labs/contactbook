...
export const mockContacts: ContactDetail[] = [
  {
    ...
    tags: [{ id: "sample-tag-vip", name: "VIP" }],
    groups: [{ id: "sample-group-work", name: "Work", source: null, externalId: null }],
    providerLinks: [
      {
        source: "GOOGLE",
        externalId: "sample/google/1",
  ...
  },
  {
    ...
    urls: [],
    tags: [],
    groups: [{ id: "sample-group-personal", name: "Personal", source: null, externalId: null }],
    providerLinks: [
      {
        source: "VCARD",
        externalId: "sample/vcard/2",
